...
{
  public:
	changManderConcrete01(int tag, double ifcc, double iecc, double iEc, double irn_pre, double irn_post, double ift, double iet, double irp, double ixp_cr);    
  ...
  private:
	  ...
	  double r_n_pre; //parameter that controls the nonlinear decending branch of the curve
	  double r_n_post; //parameter that controls the nonlinear decending branch of the curve
	  ...
	  double x_p_cr; //critical point on the positive envelope curve
