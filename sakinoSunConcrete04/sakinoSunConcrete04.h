...
// $Source: /scratch/slocal/chroot/cvsroot/openseescomp/CompositePackages/sakinoSunConcrete04/sakinoSunConcrete04.h,v $
                                                                        
#ifndef sakinoSunConcrete04_h
#define sakinoSunConcrete04_h

// Written: Mark D. Denavit and Tiziano Perea
//
// sakinoSunConcrete04 is based on the Sakino and Sun pre and post compression curve for concrete
//
// Based on Concrete04 material written by N.Mitra (nmitra@u.washington.edu) 
//
// What: "@(#) sakinoSunConcrete04.h, revA"

#include <UniaxialMaterial.h>

#define MAT_TAG_sakinoSunConcrete04 58638

class sakinoSunConcrete04 : public UniaxialMaterial
{
 public:
//  sakinoSunConcrete04 (int tag, double fpc, double eco, double Ec0, double w, double fct);
  sakinoSunConcrete04 (int tag, double fpc, double eco, double Ec0, double w, double fct, double etu, double beta);
  sakinoSunConcrete04 ();
  ~sakinoSunConcrete04();

  const char *getClassType(void) const {return "sakinoSunConcrete04";};
